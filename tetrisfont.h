...
const uint8_t tetris_font_bitmap [] PROGMEM = {
  ...
  0x0,0x30,0x30,0x30,0x30,0x3C,0x3C,0x0,  // 224  L
  0x0,0x0C,0x0C,0x0C,0x0C,0x3C,0x3C,0x0  // 225  J
};

const DCfont tetris_font = {
  (uint8_t *)tetris_font_bitmap,
  8, // character width in pixels
  1, // character height in pages (8 pixels)
  175,225 // ASCII extents
};
